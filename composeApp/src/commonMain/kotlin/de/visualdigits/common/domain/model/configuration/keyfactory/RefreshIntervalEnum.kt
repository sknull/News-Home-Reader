...
import de.visualdigits.compose.resources.label_10_minutes
...
import de.visualdigits.compose.resources.label_5_minutes
...
enum class RefreshIntervalEnum(
    ...
    MINUTES_5( UiText.StringResourceId(Res.string.label_5_minutes),  null, 5),
    MINUTES_10(UiText.StringResourceId(Res.string.label_10_minutes),  null, 10),

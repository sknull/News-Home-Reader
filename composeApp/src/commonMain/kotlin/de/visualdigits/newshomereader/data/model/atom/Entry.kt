...
data class Entry(
    ...
    @XmlElement(true) @XmlSerialName("date") val date: KmpOffsetDateTime? = null,
    @XmlElement(true) @XmlSerialName("updated") val updated: KmpOffsetDateTime? = null,
    @XmlElement(true) @XmlSerialName("published") val published: KmpOffsetDateTime? = null,

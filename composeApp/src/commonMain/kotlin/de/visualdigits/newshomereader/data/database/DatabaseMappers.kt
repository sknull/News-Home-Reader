    ...
    return Settings(
        valueMap(
            ...
            values = mapOf(
                ...
                SK.prefetchImages to BooleanEnum.fromValue(prefetchImages),
...
fun NewsFeed.toNewsFeedEntity(): NewsFeedEntity {
    return NewsFeedEntity(
        ...
        updatedMillis = updated?.toInstant()?.toEpochMilliseconds()?:0,
...
fun NewsItem.toNewsItemEntity(): NewsItemEntity {
    return NewsItemEntity(
        ...
        feedName = feedName,
        identifier = identifier,
        publishedMillis = published?.toInstant()?.toEpochMilliseconds()?:0,

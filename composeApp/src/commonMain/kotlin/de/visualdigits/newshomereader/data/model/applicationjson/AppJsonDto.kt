...
data class AppJsonDto @OptIn(ExperimentalSerializationApi::class, ExperimentalSerializationApi::class,
    ...
    @XmlSerialName("dateModified") val dateModified: KmpOffsetDateTime? = null,
    @XmlSerialName("datePublished") val datePublished: KmpOffsetDateTime? = null,
    val description: String? = null,
    val discussionUrl: String? = null,
    val duration: String? = null,
    @XmlSerialName("expires") val expires: KmpOffsetDateTime? = null,
    ...
    @XmlSerialName("uploadDate") val uploadDate: KmpOffsetDateTime? = null,
    val url: String? = null,

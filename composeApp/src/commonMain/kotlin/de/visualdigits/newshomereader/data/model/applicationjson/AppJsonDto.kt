...
data class AppJsonDto @OptIn(ExperimentalSerializationApi::class, ExperimentalSerializationApi::class,
    ...
    @SerialName("@graph") @Serializable(with = ListSerializer::class) val graphs: List<AppJsonDto> = listOf(),
    ...
    @XmlSerialName("dateModified") val dateModified: KmpOffsetDateTime = KmpOffsetDateTime.now(),
    ...
    @XmlSerialName("expires") val expires: KmpOffsetDateTime = KmpOffsetDateTime.now(),
    ...
    @XmlSerialName("uploadDate") val uploadDate: KmpOffsetDateTime = KmpOffsetDateTime.now(),
    val url: String? = null,

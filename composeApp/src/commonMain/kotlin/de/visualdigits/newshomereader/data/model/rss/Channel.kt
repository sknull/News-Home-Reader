...
data class Channel(
    ...
    @XmlSerialName("date") @XmlElement(true) val date: KmpOffsetDateTime = KmpOffsetDateTime.MIN,
    @XmlElement(true) val updatePeriod: String? = null,
    @XmlElement(true) val updateFrequency: String? = null,
    @XmlSerialName("updateBase") @XmlElement(true) val updateBase: KmpOffsetDateTime = KmpOffsetDateTime.MIN,
    ...
    @XmlSerialName("lastBuildDate") @XmlElement(true) val lastBuildDate: KmpOffsetDateTime = KmpOffsetDateTime.MIN,
    @XmlSerialName("pubDate") @XmlElement(true) val pubDate: KmpOffsetDateTime = KmpOffsetDateTime.MIN,

...
data class Channel(
    ...
    @XmlSerialName("date") @XmlElement(true) val date: KmpOffsetDateTime? = null,
    @XmlElement(true) val updatePeriod: String? = null,
    @XmlElement(true) val updateFrequency: String? = null,
    @XmlSerialName("updateBase") @XmlElement(true) val updateBase: KmpOffsetDateTime? = null,
    ...
    @XmlSerialName("lastBuildDate") @XmlElement(true) val lastBuildDate: KmpOffsetDateTime? = null,
    @XmlSerialName("pubDate") @XmlElement(true) val pubDate: KmpOffsetDateTime? = null,
